...
describe("Formula", function () {
  ...
  describe("Conjunction", function () {
    it('Parsing of "A ∧ B" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let conjunction = new Conjunction(
          propositionalVariableA,
          propositionalVariableB
        );
    ...
    it('Parsing of "A ∧ B ∧ C ∧ D ∧ E" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let conjunction1 = new Conjunction(
          propositionalVariableA,
          propositionalVariableB
        );
        let conjunction2 = new Conjunction(
          conjunction1,
          propositionalVariableC
        );
        let conjunction3 = new Conjunction(
          conjunction2,
          propositionalVariableD
        );
        let conjunction4 = new Conjunction(
          conjunction3,
          propositionalVariableE
        );
  ...
  describe("Disjunction", function () {
    it('Parsing of "A ∨ B" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableA = new PropositionalVariable("A");
        let propositionalVariableB = new PropositionalVariable("B");
        let disjunction = new Disjunction(
          propositionalVariableA,
          propositionalVariableB
        );
    ...
    it('Parsing of "A ∨ B ∨ C ∨ D ∨ E" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableD = new PropositionalVariable("D");
        let propositionalVariableE = new PropositionalVariable("E");
        let disjunction1 = new Disjunction(
          propositionalVariableA,
          propositionalVariableB
        );
        let disjunction2 = new Disjunction(
          disjunction1,
          propositionalVariableC
        );
        let disjunction3 = new Disjunction(
          disjunction2,
          propositionalVariableD
        );
        let disjunction4 = new Disjunction(
          disjunction3,
          propositionalVariableE
        );
  ...
  describe("Implication", function () {
    it('Parsing of "A → B" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableA = new PropositionalVariable("A");
        let propositionalVariableB = new PropositionalVariable("B");
        let implication = new Implication(
          propositionalVariableA,
          propositionalVariableB
        );
    ...
    it('Parsing of "A → B → C → D → E" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableD = new PropositionalVariable("D");
        let propositionalVariableE = new PropositionalVariable("E");
        let implication1 = new Implication(
          propositionalVariableA,
          propositionalVariableB
        );
        let implication2 = new Implication(
          implication1,
          propositionalVariableC
        );
        let implication3 = new Implication(
          implication2,
          propositionalVariableD
        );
        let implication4 = new Implication(
          implication3,
          propositionalVariableE
        );
  ...
  describe("Biconditional", function () {
    it('Parsing of "A ↔ B" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableA = new PropositionalVariable("A");
        let propositionalVariableB = new PropositionalVariable("B");
        let biconditional = new Biconditional(
          propositionalVariableA,
          propositionalVariableB
        );
    ...
    it('Parsing of "A ↔ B ↔ C ↔ D ↔ E" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let propositionalVariableD = new PropositionalVariable("D");
        let propositionalVariableE = new PropositionalVariable("E");
        let biconditional1 = new Biconditional(
          propositionalVariableA,
          propositionalVariableB
        );
        let biconditional2 = new Biconditional(
          biconditional1,
          propositionalVariableC
        );
        let biconditional3 = new Biconditional(
          biconditional2,
          propositionalVariableD
        );
        let biconditional4 = new Biconditional(
          biconditional3,
          propositionalVariableE
        );
  ...
  describe("Universal", function () {
    ...
    it('Parsing of "∀x∀y∀z[related(x, y, z)]" and equivalent', function () {
      ...
      formulas.forEach(function (formula) {
        ...
        let relation = new Relation("related", [
          variableX,
          variableY,
          variableZ,
        ]);
  ...
  describe("Equality", function () {
    it('Parsing of "funct(const, another(further), additional) = some"', function () {
  ...
  describe("Combined", function () {
    it(
      'Parsing of "(A | B) ^ C -> (E)item[red(item, ' +
        'function(inner(constant), anotherconstant))] & D & E"',
      function () {
        let formula =
          "(A | B) ^ C -> (E)item[red(item, " +
          "function(inner(constant), anotherconstant))] & D & E";
        let signature = {
          constants: new Set([]),
          skolemNext: 1,
